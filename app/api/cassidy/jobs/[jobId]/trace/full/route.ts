...
import { getFullTrace } from "@server/integrations/cassidy/trace-builder";
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: sanitizeErrorMessage(err, "Failed to get full trace") }, { status: 500 });
  }
}
