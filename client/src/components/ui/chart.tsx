...
// Static import — avoids Next.js 16 dynamic import chunk resolution bug
type RechartsMod = typeof import("recharts");
function useRecharts(): RechartsMod | null {
  return RechartsPrimitive as RechartsMod;
}
...
`
  ...
  return (
    <SafeHtml as="style" html={cssText} />
  )
}
...
const ChartTooltip = React.forwardRef<any, any>((props, ref) => {
  const recharts = useRecharts()
  if (!recharts) return null
  return React.createElement(recharts.Tooltip as unknown as React.ForwardRefExoticComponent<Record<string, unknown>>, { ...props, ref })
}) as unknown as typeof RechartsPrimitiveTypes.Tooltip
...
const ChartLegend = React.forwardRef<any, any>((props, ref) => {
  const recharts = useRecharts()
  if (!recharts) return null
  return React.createElement(recharts.Legend as unknown as React.ForwardRefExoticComponent<Record<string, unknown>>, { ...props, ref })
}) as unknown as typeof RechartsPrimitiveTypes.Legend
