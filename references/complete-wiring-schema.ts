...
//   4. All meeting requirements and architecture decisions
...
export const CLIENTS_WIRING = {
  ...
  CRITICAL_MISSING: "HOUSEHOLD VIEW —  → Household[] view.",
};
...
export const EXECUTION_PLAN = [
  ...
  "  - Add household hierarchy view per architecture decision",
